...
const Edit = ({ faq }) => {
	...
	const handleSubmitFAQ = async (data) => {
		...
		const response = await fetch('/api/admin/faq/edit', {
	...
	useEffect(() => {
		setRsQuestion(getFAQ(faq.question, 'rs', 'question', false));
		setBaQuestion(getFAQ(faq.question, 'ba', 'question', false));
		setHrQuestion(getFAQ(faq.question, 'hr', 'question', false));
		setMeQuestion(getFAQ(faq.question, 'me', 'question', false));
		setSiQuestion(getFAQ(faq.question, 'si', 'question', false));
		setGbQuestion(getFAQ(faq.question, 'gb', 'question', false));
		setDeQuestion(getFAQ(faq.question, 'de', 'question', false));
		setItQuestion(getFAQ(faq.question, 'it', 'question', false));
		setRsAnswer(getFAQ(faq.answer, 'rs', 'answer', false));
		setBaAnswer(getFAQ(faq.answer, 'ba', 'answer', false));
		setHrAnswer(getFAQ(faq.answer, 'hr', 'answer', false));
		setMeAnswer(getFAQ(faq.answer, 'me', 'answer', false));
		setSiAnswer(getFAQ(faq.answer, 'si', 'answer', false));
		setGbAnswer(getFAQ(faq.answer, 'gb', 'answer', false));
		setDeAnswer(getFAQ(faq.answer, 'de', 'answer', false));
		setItAnswer(getFAQ(faq.answer, 'it', 'answer', false));
		// eslint-disable-next-line react-hooks/exhaustive-deps
	}, []);
	return (
		<div>
			<form className="max-w-[600px] m-auto" onSubmit={handleSubmit(handleSubmitFAQ)}>
				...
				<button className="btn btn-block btn-primary my-5">Edit</button>
				{success !== '' && (
